...
{   
    ...
    while(1){
        ...
        if (rand == 0){
            TOBACCO_NUM++;
            MATCH_NUM++;
            printf("22336173LHJ offer material for smoker_have_paper %d\n", rand+1);
        }else if (rand == 1){
            PAPER_NUM++;
            TOBACCO_NUM++;
            printf("22336173LHJ offer material for smoker_have_match%d\n", rand+1);
        }else{
            MATCH_NUM++;
            PAPER_NUM++;
            printf("22336173LHJ offer material for smoker_have_tobacco %d\n", rand+1);
        }
        SIGNAL = 0;
    }
}
